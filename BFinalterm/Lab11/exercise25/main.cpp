...
int main()
{
	...
	graph.AddEdge("crab", "vertebrate", 70);
	graph.AddEdge("oyster", "vertebrate", 80);
	...
	cout << "Weight of 'vertebrate to animal' is " << graph.WeightIs("poodle", "dog") << endl;

	cout << endl << endl;
	graph.DepthFirstSearch("dalmation", "animal");
	cout << endl;
